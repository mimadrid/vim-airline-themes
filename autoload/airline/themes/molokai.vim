...
if get(g:, 'airline_molokai_bright', 0)
  let s:N2 = [ '#f8f8f0' , '#232526' , 232 , 208 ] " info
else
  let s:N2 = [ '#f8f8f0' , '#232526' , 253 , 16 ] " info
endif
let s:N3 = [ '#f8f8f0' , '#465457' , 232 , 67 , 'bold' ] " statusline
...
let g:airline#themes#molokai#palette.normal_modified = {
      \ 'airline_c': [ '#080808' , '#e6db74' , 232 , 144 , 'bold' ] ,
      \ 'airline_x': [ '#080808' , '#e6db74' , 232 , 144 , 'bold' ] ,
      \ }

" Insert mode
let s:I1 = [ '#080808' , '#66d9ef' , 232 , 81, 'bold'  ]
if get(g:, 'airline_molokai_bright', 0)
  let s:I2 = [ '#f8f8f0' , '#232526' , 232 , 208 ]
else
  let s:I2 = [ '#f8f8f0' , '#232526' , 253 , 16 ]
endif
let s:I3 = [ '#f8f8f0' , '#465457' , 232 , 67, 'bold' ]
...
let g:airline#themes#molokai#palette.insert_modified = {
      \ 'airline_c': [ '#080808' , '#66d9ef' , 232 , 81 , 'bold' ] ,
      \ 'airline_x': [ '#080808' , '#66d9ef' , 232 , 81 , 'bold' ] ,
      \ }

" Replace mode
let s:R1 = [ '#080808' , '#f92672' , 232 , 161 ]
if get(g:, 'airline_molokai_bright', 0)
  let s:R2 = [ '#f8f8f0' , '#232526' , 232 , 208 ]
else
  let s:R2 = [ '#f8f8f0' , '#232526' , 253 , 16 ]
endif
let s:R3 = [ '#f8f8f0' , '#465457' , 232 , 67 , 'bold' ]
...
let g:airline#themes#molokai#palette.replace_modified = {
      \ 'airline_c': [ '#080808' , '#f92672' , 232 , 161 , 'bold' ] ,
      \ 'airline_x': [ '#080808' , '#f92672' , 232 , 161 , 'bold' ] ,
      \ }

" Visual mode
let s:V1 = [ '#080808' , '#a6e22e' , 232 , 118 ]
if get(g:, 'airline_molokai_bright', 0)
  let s:V2 = [ '#f8f8f0' , '#232526' , 232 , 208 ]
else
  let s:V2 = [ '#f8f8f0' , '#232526' , 253 , 16 ]
endif
let s:V3 = [ '#f8f8f0' , '#465457' , 232 , 67 , 'bold' ]
...
let g:airline#themes#molokai#palette.visual_modified = {
      \ 'airline_c': [ '#080808' , '#a6e22e' , 232 , 118 , 'bold' ] ,
      \ 'airline_x': [ '#080808' , '#a6e22e' , 232 , 118 , 'bold' ] ,
      \ }
